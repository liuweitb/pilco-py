...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a readable PILCO-style pendulum controller.")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/pendulum"), help="Artifact directory.")
